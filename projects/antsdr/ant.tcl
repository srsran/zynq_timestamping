...
create_project ant ${script_dir}/vivado_prj -force
# Properties 
...
add_files -fileset [get_filesets sources_1] ${script_dir}/hdl/projects/ant/system_top.v
# IP repo
if { $argc == 2 } {
...
add_files -fileset [get_filesets constrs_1] ${script_dir}/hdl/projects/ant/system_constr.xdc
...
# Top
make_wrapper -files [get_files ${script_dir}/vivado_prj/ant.srcs/sources_1/bd/system/system.bd] -top
add_files -norecurse ${script_dir}/vivado_prj/ant.srcs/sources_1/bd/system/hdl/system_wrapper.v
# ADC
#source ${script_dir}/antsdr-fw/hdl/library/axi_ad9361/axi_ad9361_delay.tcl
# Generate bitstream
set run_step [lindex $argv 0]
if { $run_step == "bitstream" } {
  launch_runs impl_1 -verbose -to_step write_bitstream -jobs 4
  wait_on_run impl_1
