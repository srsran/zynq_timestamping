...
softwareradiosystems.com:user:system_control:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#ENET Reset#USB Reset#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#tx#rx#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#gpio[40]#gpio[41]#gpio[42]#gpio[43]#gpio[44]#gpio[45]#reset#reset#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  # Create instance: system_control_0, and set properties
  set system_control_0 [ create_bd_cell -type ip -vlnv softwareradiosystems.com:user:system_control:1.0 system_control_0 ]
  ...
  # Create instance: util_upack2_0, and set properties
  set util_upack2_0 [ create_bd_cell -type ip -vlnv analog.com:user:util_upack2:1.0 util_upack2_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_ad9361_dac_dma_m_axis [get_bd_intf_pins axi_ad9361_dac_dma/m_axis] [get_bd_intf_pins util_upack2_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M05_AXI [get_bd_intf_pins axi_cpu_interconnect/M05_AXI] [get_bd_intf_pins system_control_0/s_axi]
  ...
  connect_bd_net -net M03_AXI_awready_1 [get_bd_pins axi_ad9361_dac_dma/s_axi_awready] [get_bd_pins axi_cpu_interconnect/M03_AXI_awready] [get_bd_pins dac_dmac_xlength_sni_0/fwd_s_axi_awready]
  ...
  connect_bd_net -net M03_AXI_bvalid_1 [get_bd_pins axi_ad9361_dac_dma/s_axi_bvalid] [get_bd_pins axi_cpu_interconnect/M03_AXI_bvalid] [get_bd_pins dac_dmac_xlength_sni_0/fwd_s_axi_bvalid]
  ...
  connect_bd_net -net M03_AXI_wready_1 [get_bd_pins axi_ad9361_dac_dma/s_axi_wready] [get_bd_pins axi_cpu_interconnect/M03_AXI_wready] [get_bd_pins dac_dmac_xlength_sni_0/fwd_s_axi_wready]
  ...
  connect_bd_net -net adc_dmac_xlength_sni_0_DMA_x_length [get_bd_pins adc_dmac_xlength_sni_0/DMA_x_length] [get_bd_pins adc_fifo_timestamp_e_0/DMA_x_length]
  connect_bd_net -net adc_dmac_xlength_sni_0_DMA_x_length_valid [get_bd_pins adc_dmac_xlength_sni_0/DMA_x_length_valid] [get_bd_pins adc_fifo_timestamp_e_0/DMA_x_length_valid]
  connect_bd_net -net adc_fifo_timestamp_e_0_ADC_FSM_new_status [get_bd_pins adc_fifo_timestamp_e_0/ADC_FSM_new_status] [get_bd_pins system_control_0/adc_fsm_status_valid_in]
  connect_bd_net -net adc_fifo_timestamp_e_0_ADC_FSM_status [get_bd_pins adc_fifo_timestamp_e_0/ADC_FSM_status] [get_bd_pins system_control_0/adc_fsm_status_in]
  connect_bd_net -net adc_fifo_timestamp_e_0_fwd_DMA_x_length [get_bd_pins adc_dma_packet_contr_0/DMA_x_length] [get_bd_pins adc_fifo_timestamp_e_0/fwd_DMA_x_length]
  connect_bd_net -net adc_fifo_timestamp_e_0_fwd_DMA_x_length_valid [get_bd_pins adc_dma_packet_contr_0/DMA_x_length_valid] [get_bd_pins adc_fifo_timestamp_e_0/fwd_DMA_x_length_valid]
  ...
  connect_bd_net -net adc_fifo_timestamp_e_0_fwd_adc_overflow_BBclk [get_bd_pins adc_fifo_timestamp_e_0/fwd_adc_overflow_BBclk] [get_bd_pins axi_ad9361/adc_dovf]
  ...
  connect_bd_net -net axi_ad9361_l_clk [get_bd_pins adc_dmac_xlength_sni_0/ADCxN_clk] [get_bd_pins adc_fifo_timestamp_e_0/ADCxN_clk] [get_bd_pins axi_ad9361/clk] [get_bd_pins axi_ad9361/l_clk] [get_bd_pins dac_control_s_axi_ac_0/DACxN_clk] [get_bd_pins dac_fifo_timestamp_e_0/DACxN_clk] [get_bd_pins system_control_0/clk] [get_bd_pins timestamp_unit_lclk_0/ADCxN_clk]
  connect_bd_net -net axi_ad9361_rst [get_bd_pins adc_fifo_timestamp_e_0/ADCxN_reset] [get_bd_pins axi_ad9361/rst] [get_bd_pins dac_fifo_timestamp_e_0/DACxN_reset] [get_bd_pins timestamp_unit_lclk_0/ADCxN_reset]
  ...
  connect_bd_net -net axi_cpu_interconnect_M03_AXI_awaddr [get_bd_pins axi_ad9361_dac_dma/s_axi_awaddr] [get_bd_pins axi_cpu_interconnect/M03_AXI_awaddr] [get_bd_pins dac_dmac_xlength_sni_0/s_axi_awaddr]
  ...
  connect_bd_net -net axi_cpu_interconnect_M03_AXI_awvalid [get_bd_pins axi_ad9361_dac_dma/s_axi_awvalid] [get_bd_pins axi_cpu_interconnect/M03_AXI_awvalid] [get_bd_pins dac_dmac_xlength_sni_0/s_axi_awvalid]
  connect_bd_net -net axi_cpu_interconnect_M03_AXI_bready [get_bd_pins axi_ad9361_dac_dma/s_axi_bready] [get_bd_pins axi_cpu_interconnect/M03_AXI_bready] [get_bd_pins dac_dmac_xlength_sni_0/s_axi_bready]
  ...
  connect_bd_net -net axi_cpu_interconnect_M03_AXI_wdata [get_bd_pins axi_ad9361_dac_dma/s_axi_wdata] [get_bd_pins axi_cpu_interconnect/M03_AXI_wdata] [get_bd_pins dac_dmac_xlength_sni_0/s_axi_wdata]
  ...
  connect_bd_net -net axi_cpu_interconnect_M03_AXI_wvalid [get_bd_pins axi_ad9361_dac_dma/s_axi_wvalid] [get_bd_pins axi_cpu_interconnect/M03_AXI_wvalid] [get_bd_pins dac_dmac_xlength_sni_0/s_axi_wvalid]
  ...
  connect_bd_net -net dac_control_s_axi_ac_0_s_axi_dac_enable_0 [get_bd_pins dac_control_s_axi_ac_0/s_axi_dac_enable_0] [get_bd_pins dac_fifo_timestamp_e_0/dac_enable_0] [get_bd_pins util_upack2_0/enable_0]
  connect_bd_net -net dac_control_s_axi_ac_0_s_axi_dac_enable_1 [get_bd_pins dac_control_s_axi_ac_0/s_axi_dac_enable_1] [get_bd_pins dac_fifo_timestamp_e_0/dac_enable_1] [get_bd_pins util_upack2_0/enable_1]
  connect_bd_net -net dac_control_s_axi_ac_0_s_axi_dac_enable_2 [get_bd_pins dac_control_s_axi_ac_0/s_axi_dac_enable_2] [get_bd_pins dac_fifo_timestamp_e_0/dac_enable_2] [get_bd_pins util_upack2_0/enable_2]
  connect_bd_net -net dac_control_s_axi_ac_0_s_axi_dac_enable_3 [get_bd_pins dac_control_s_axi_ac_0/s_axi_dac_enable_3] [get_bd_pins dac_fifo_timestamp_e_0/dac_enable_3] [get_bd_pins util_upack2_0/enable_3]
  ...
  connect_bd_net -net dac_dmac_xlength_sni_0_DMA_x_length [get_bd_pins dac_dmac_xlength_sni_0/DMA_x_length] [get_bd_pins dac_fifo_timestamp_e_0/DMA_x_length]
  connect_bd_net -net dac_dmac_xlength_sni_0_DMA_x_length_valid [get_bd_pins dac_dmac_xlength_sni_0/DMA_x_length_valid] [get_bd_pins dac_fifo_timestamp_e_0/DMA_x_length_valid]
  connect_bd_net -net dac_fifo_timestamp_e_0_DAC_FSM_new_status [get_bd_pins dac_fifo_timestamp_e_0/DAC_FSM_new_status] [get_bd_pins system_control_0/dac_fsm_status_valid_in]
  connect_bd_net -net dac_fifo_timestamp_e_0_DAC_FSM_status [get_bd_pins dac_fifo_timestamp_e_0/DAC_FSM_status] [get_bd_pins system_control_0/dac_fsm_status_in]
  connect_bd_net -net dac_fifo_timestamp_e_0_DAC_late_flag [get_bd_pins dac_fifo_timestamp_e_0/DAC_late_flag] [get_bd_pins system_control_0/dac_late_flag_in]
  connect_bd_net -net dac_fifo_timestamp_e_0_DAC_new_late [get_bd_pins dac_fifo_timestamp_e_0/DAC_new_late] [get_bd_pins system_control_0/dac_late_flag_valid_in]
  ...
  connect_bd_net -net logic_or_Res [get_bd_pins logic_or/Res] [get_bd_pins util_upack2_0/fifo_rd_en]
  ...
  connect_bd_net -net system_control_0_adc_fsm_status_read_out [get_bd_pins adc_fifo_timestamp_e_0/ADC_FSM_status_read] [get_bd_pins system_control_0/adc_fsm_status_read_out]
  connect_bd_net -net system_control_0_dac_fsm_status_read_out [get_bd_pins dac_fifo_timestamp_e_0/DAC_FSM_status_read] [get_bd_pins system_control_0/dac_fsm_status_read_out]
  connect_bd_net -net timestamp_unit_lclk_0_current_lclk_count [get_bd_pins adc_fifo_timestamp_e_0/current_lclk_count] [get_bd_pins dac_fifo_timestamp_e_0/current_lclk_count] [get_bd_pins timestamp_unit_lclk_0/current_lclk_count]
  ...
  connect_bd_net -net util_upack2_0_fifo_rd_data_0 [get_bd_pins dac_fifo_timestamp_e_0/dac_data_0] [get_bd_pins util_upack2_0/fifo_rd_data_0]
  connect_bd_net -net util_upack2_0_fifo_rd_data_1 [get_bd_pins dac_fifo_timestamp_e_0/dac_data_1] [get_bd_pins util_upack2_0/fifo_rd_data_1]
  connect_bd_net -net util_upack2_0_fifo_rd_data_2 [get_bd_pins dac_fifo_timestamp_e_0/dac_data_2] [get_bd_pins util_upack2_0/fifo_rd_data_2]
  connect_bd_net -net util_upack2_0_fifo_rd_data_3 [get_bd_pins dac_fifo_timestamp_e_0/dac_data_3] [get_bd_pins util_upack2_0/fifo_rd_data_3]
  connect_bd_net -net util_upack2_0_fifo_rd_underflow [get_bd_pins dac_fifo_timestamp_e_0/dac_fifo_unf] [get_bd_pins util_upack2_0/fifo_rd_underflow]
  connect_bd_net -net util_upack2_0_fifo_rd_valid [get_bd_pins dac_fifo_timestamp_e_0/dac_valid_0] [get_bd_pins dac_fifo_timestamp_e_0/dac_valid_1] [get_bd_pins dac_fifo_timestamp_e_0/dac_valid_2] [get_bd_pins dac_fifo_timestamp_e_0/dac_valid_3] [get_bd_pins util_upack2_0/fifo_rd_valid]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins adc_dma_packet_contr_0/ADCxN_reset] [get_bd_pins cpack/reset] [get_bd_pins util_upack2_0/reset] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins adc_fifo_timestamp_e_0/ADC_clk_division] [get_bd_pins dac_control_s_axi_ac_0/DAC_clk_division] [get_bd_pins dac_fifo_timestamp_e_0/DAC_clk_division] [get_bd_pins timestamp_unit_lclk_0/ADC_clk_division] [get_bd_pins xlconstant_0/dout]
  ...
  assign_bd_address -offset 0x50000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs system_control_0/s_axi/reg0] -force
