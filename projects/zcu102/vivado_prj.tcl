...
update_ip_catalog
# XDC files
add_files -fileset [get_filesets constrs_1] ${script_dir}/src/constraints/system_constr.xdc
add_files -fileset [get_filesets constrs_1] ${script_dir}/src/constraints/zcu102_system_constr.xdc
################################################################################
# Synthesis config
################################################################################
...
add_files -fileset [get_filesets sources_1] ${script_dir}/src/hdl/system_top.v
