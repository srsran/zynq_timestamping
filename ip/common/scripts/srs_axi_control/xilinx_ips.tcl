...
set_property -dict [list \
  ...
  CONFIG.Component_Name {CDC_fifo_21b} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_21b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_15b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_15b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_15b.xci]
#  fifo_generator 

#  fifo_generator Properties definition 
set ip_name CDC_fifo_14b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_14b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_14b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_10b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_10b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_10b.xci]
#  fifo_generator  

set ip_name CDC_fifo_12b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_12b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_12b.xci]
#  fifo_generator  
...
set_property -dict [list \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_17b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_17b.xci]
#  fifo_generator  
...
set_property -dict [list \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_2b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_2b.xci]
#  fifo_generator  
...
set_property -dict [list \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_4b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_4b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_5b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_5b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_5b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_64b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_64b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_64b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_6b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_6b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_6b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_7b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_7b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_7b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_8b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_8b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_8b.xci]
#  fifo_generator  

#  fifo_generator Properties definition 
set ip_name CDC_fifo_9b
create_ip -name fifo_generator -vendor xilinx.com -library ip -module_name ${ip_name}
set_property -dict [list \
  CONFIG.ADDRESS_WIDTH {32} \
  CONFIG.ARUSER_Width {0} \
  ...
  CONFIG.Clock_Enable_Type {Slave_Interface_Clock_Enable} \
  CONFIG.Clock_Type_AXI {Common_Clock} \
  CONFIG.Component_Name {CDC_fifo_9b} \
  CONFIG.DATA_WIDTH {64} \
  CONFIG.Data_Count {false} \
  CONFIG.Data_Count_Width {4} \
  CONFIG.Disable_Timing_Violations {false} \
...
set_property generate_synth_checkpoint 0 [get_files CDC_fifo_9b.xci]
#  fifo_generator  
